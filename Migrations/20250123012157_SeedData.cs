...
namespace GraphQLProject.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CustomerName", "Email", "PhoneNumber", "ReservationDate", "SpecialRequest", "partySize" },
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", "555-123-4567", new DateTime(2025, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "No nuts in the dishes, please.", 2 },
                    { 2, "Jane Smith", "janesmith@example.com", "555-987-6543", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gluten-free options required.", 4 },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", "555-789-0123", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Celebrating a birthday.", 6 }
                });
